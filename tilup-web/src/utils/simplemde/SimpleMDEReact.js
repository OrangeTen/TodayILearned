 ...
 *  to two-way-bind props.value with simplemde.value
 */
...
export default class SimpleMDEReact extends Component {
  static defaultProps = {
    events: {},
    onChange: {},
    options: {}
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps && nextProps.value !== this.simplemde.value()) {
